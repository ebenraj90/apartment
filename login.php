    ...
    >
      <div class="fixed top-0 hidden p-6 lg:block lg:px-12">
        <a href="#" class="flex items-center space-x-2">
          <img class="size-12" src="assets/images/app-logo.svg" alt="logo" />
          <p
      ...
      <div class="hidden w-full place-items-center lg:grid">
        <div class="w-full max-w-lg p-6">
          <img
            ...
            src="assets/images/illustrations/dashboard-check.svg"
            alt="image"
          />
          <img
            class="w-full"
            x-show="$store.global.isDarkModeEnabled"
            src="assets/images/illustrations/dashboard-check-dark.svg"
            alt="image"
          />
        </div>
      </div>
      ...
      >
        ...
        <button id="loginButton" class="btn mt-10 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">Sign In</button>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (data.status == 'success') {
                            ...
                            window.location.href = '/apartment/dashboard.php';
                        } else {
